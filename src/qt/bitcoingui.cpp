    ...
    rpcConsole(0)
{
    ...
    transactionsPage->setFixedHeight(524);
    transactionsPage->setFixedWidth(693);
    ...
    frameBlocksLayout->setContentsMargins(20,0,0,0); //28  Linie für Toolbaar
    ...
    toolbar2->setFixedWidth(88);  // Für Balance
...
//"QDialog {background-color: black;} #frame { } QToolBar QLabel { padding-top:15px;padding-bottom:10px;margin:0px; }"
// padding-top:15px; = Höhe
//"#spacer { background:rgb(36,36,36);border:none; }"
    ...
    "#toolbar {background: transparent; border: none; margin-top: 15px;}"
...
void BitcoinGUI::createActions()
{
    ...
    overviewAction = new QAction(QIcon(":/images/home"), tr(""), this);
    overviewAction->setToolTip(tr("Show general overview of wallet"));
    overviewAction->setCheckable(true);
    overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
    tabGroup->addAction(overviewAction);
	
	//chatAction = new QAction(QIcon(":/icons/irc"), tr("&XDE2 IRC"), this);
    //chatAction->setToolTip(tr("View chat"));
    //chatAction->setCheckable(true);
    //tabGroup->addAction(chatAction);

    sendCoinsAction = new QAction(QIcon(":/images/send"), tr(""), this);
    sendCoinsAction->setToolTip(tr("Send coins to a XDE2Coin address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/images/receive"), tr(""), this);
    receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
    receiveCoinsAction->setCheckable(true);
    receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
    tabGroup->addAction(receiveCoinsAction);

    historyAction = new QAction(QIcon(":/images/tx"), tr(""), this);
    historyAction->setToolTip(tr("Browse transaction history"));
    historyAction->setCheckable(true);
    historyAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_4));
    tabGroup->addAction(historyAction);

    addressBookAction = new QAction(QIcon(":/images/addresses"), tr(""), this);
    addressBookAction->setToolTip(tr("Edit the list of stored addresses and labels"));
    addressBookAction->setCheckable(true);
    addressBookAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
    tabGroup->addAction(addressBookAction);
	
    blockAction = new QAction(QIcon(":/images/explorer"), tr(""), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About XDE2Coin"), this);
    aboutAction->setToolTip(tr("Show information about XDE2Coin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for XDE2Coin"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    appMenuBar->setStyleSheet("background: transparent;");
}
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("XDE2Coin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("XDE2Coin client"));
...
// XDE2 FORUM [DOUBLE EAGLE TALK]
void BitcoinGUI::aboutXDE2Clicked()
{
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XDE2Coin network", "", count));
}
...
void BitcoinGUI::gotoOverviewPage()
{
	...
	centralWidget->setMaximumWidth(757);
    centralWidget->setMaximumHeight(535);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid XDE2Coin address or malformed URI parameters."));
    }
