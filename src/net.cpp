...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "XDE2Coin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
	{"70.189.144.30", "70.189.144.30"},
    {"xde2.dnsalias.com", "xde2.dnsalias.com"},
	{"5.189.144.97", "5.189.144.97"},
	{"162.255.117.105", "162.255.117.105"},
	{"144.76.236.8", "144.76.236.8"},
	{"192.52.167", "192.52.167"},
	{"107.170.238.241", "107.170.238.241"},
	{"187.132.210.13", "187.132.210.13"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("XDE2Coin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. XDE2Coin is probably already running."), addrBind.ToString().c_str());
        else
