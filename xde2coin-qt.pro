...
# qmake "USE_QRCODE=1" "USE_UPNP=-" "USE_IPV6=1" xde2coin-qt.pro
...
GMP_INCLUDE_PATH= C:/depsgmp-6.0.0
...
macx:ICON = src/qt/res/icons/xde2coin.icns
macx:TARGET = "XDE2Coin-Qt"
